// lab5AviCueva.cpp : Defines the entry point for the console application.
//
...
int main()
{
	...
	double principal, monthlyPayment, salesTaxRate, salesTax, loanBalance;
	int numYears, numMonths;
	double monthlyPrincipal, monthlyInterest;
